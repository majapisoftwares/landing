...
function UnstyledInput({ id, label, className, inputClassName, labelClassName, helpTextClassName, trailingClassName, trailingInputClassName, leadingClassName, leadingInputClassName, helpText, type = "text", leading, trailing, select, children, as, innerClassName, value, ...props }) {
    const innerId = useId();
    id = id || innerId;
    ...
    {...props} className={inputClassName} id={id} type={type} value={value}>
          {children}
        </Component>
