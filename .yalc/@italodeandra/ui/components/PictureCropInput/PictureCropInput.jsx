    ...
    return (<div ref={parentRef} className={clsx("flex gap-2", className)}>
      ...
      {src && (<>
        ...
        ref={imgRef}/>
          ...
          {completedCrop && (<div className={clsx("flex flex-col gap-2", previewContainerClassName)}>
              <canvas ref={previewCanvasRef} className={previewSizeClassNames} style={{
                    objectFit: "cover",
                }}/>
              <div className="flex gap-2">
                <Button onClick={handleCrop} className={clsx("w-full", cropButtonClassName)} leading={<CheckIcon />}>
                  Crop
                </Button>
      ...
      {!src && (<>
          {value && (<div className={clsx("flex shrink-0 rounded", previewSizeClassNames)} style={{
                    background: value
                        ? `center / cover url(${value})`
                        : undefined,
                }}/>)}
          <input type="file" id={id} className="hidden" onChange={onFileSelect} accept=".jpg,.jpeg,.png"/>
