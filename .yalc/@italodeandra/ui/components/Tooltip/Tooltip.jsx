...
function Tooltip({ children, content, side, delayDuration, className, arrowClassName, ref, }) {
    if (!content) {
        return <>{children}</>;
    }
