      ...
      <div className="relative z-10 mx-auto flex w-full max-w-(--breakpoint-xl) flex-col items-center justify-center gap-[75px] px-4">
        <div className="flex max-w-[604px] flex-col items-center gap-2">
          ...
          <div className="font-dm text-center text-2xl leading-8 tracking-[-0.288px] text-zinc-500">
            At Majapi, we follow a streamlined approach to ensure the success of
            every project.
          </div>
        </div>
        <div className="relative flex flex-col gap-10 sm:gap-0 xl:flex-row">
          <ProcessStep
            icon={<LightBulbIcon />}
            title="Discovery"
            description="We collaborate to understand your business goals."
          />
          ...
          <ProcessStep
            ...
            title="Planning"
            description="We create a clear roadmap and timeline for your project."
          />
          <Arrow className="top-130 left-63 hidden scale-x-[-1] rotate-10 sm:block xl:top-29 xl:left-95 xl:rotate-180" />
          <ProcessStep
            icon={<CodeBracketSquareIcon />}
            title="Development"
            description="Our team develops and tests the solution to ensure it meets your requirements."
          />
          ...
          <ProcessStep
            ...
            className="sm:ml-70 xl:mt-70 xl:ml-0"
            title="Launch"
            description="We launch your product, providing support and ongoing optimization."
            glow
          />
        </div>
      </div>
