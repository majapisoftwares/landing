export default function Flare({ className }: { className?: string }) {
  return (
    <svg
      width="1799"
      height="1924"
      ...
      aria-hidden="true"
      className={`pointer-events-none absolute left-1/2 z-0 -mt-[900px] -translate-x-[70%] opacity-30 ${className ?? ""}`}
    >
      <g opacity="0.25">
